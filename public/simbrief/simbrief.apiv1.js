...
/**
 * Helper function to call main form submission function
 *
 * @param string URL to plan output page
 * @return redirect to specified output page
 */
...
/**
 * Function to parse form data and actually submit the form
 * Called from helper function defined above
 *
 * @param string URL to plan output page
 * @return redirect to specified output page
 */
...
/**
 * Function to launch the SimBrief service worker
 */
...
/**
 * Function to check the status of the SimBrief service worker
 */
...
/**
 * @param string URL to load result at
 * @return redirect to specified output page
 */
