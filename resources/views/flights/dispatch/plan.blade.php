...
<form id="sbapiform" action="" method="post">
                    ...
                    <div class="card-text">
                        ...
                        <div class="form-row">
                            <div class="col-sm-3 form-group">
                                ...
                                <input type="text" name="type" class="form-control" readonly value="{{ $flight->aircraft }}">
                            </div>

                            <div class="col-sm-3 form-group">
                                <label>Departure</label>
                                <input type="text" name="orig" class="form-control" maxlength="4" readonly value="{{ $flight->departure }}">
                            </div>

                            <div class="col-sm-3 form-group">
                                <label>Arrival</label>
                                <input type="text" name="dest" class="form-control" maxlength="4" readonly value="{{ $flight->arrival }}">
                            </div>
